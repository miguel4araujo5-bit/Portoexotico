    ...
    return (
      <main className="min-h-screen bg-[#fcf8fa] px-6 py-16 text-neutral-900 md:px-10">
        <div className="mx-auto max-w-5xl">
          ...
          <span className="mt-8 inline-block rounded-full border border-[#8f355d]/10 bg-white px-4 py-2 text-[11px] uppercase tracking-[0.3em] text-[#9b5a79]">
            Produto
          </span>
          ...
          <Link
            to="/loja"
            className="mt-8 inline-flex items-center rounded-full bg-[linear-gradient(135deg,#8f355d_0%,#a84f78_100%)] px-6 py-3 text-sm font-medium text-white shadow-[0_14px_34px_rgba(143,53,93,0.22)] transition duration-300 hover:-translate-y-0.5"
          >
            Voltar à loja
          </Link>
        </div>
    ...
    <main className="min-h-screen bg-[#fcf8fa] px-6 py-16 text-neutral-900 md:px-10">
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.02fr_0.98fr]">
        <section className="overflow-hidden rounded-[2rem] border border-[#8f355d]/10 bg-white shadow-[0_24px_70px_rgba(143,53,93,0.08)]">
          <div className="relative min-h-[420px] overflow-hidden bg-[#f7edf2] md:min-h-[560px]">
            ...
            <div className="absolute inset-x-0 bottom-0 p-6">
              <div className="max-w-lg rounded-[1.6rem] border border-white/15 bg-white/10 p-5 backdrop-blur-md">
                ...
                <h2 className="mt-4 font-serif text-2xl font-semibold leading-tight text-white md:text-3xl">
                  {product.name}
                </h2>

                <p className="mt-3 text-sm leading-6 text-white/80">
                  Seleção cuidada para quem valoriza discrição, conforto e uma experiência de compra
                  mais elegante e segura.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="flex flex-col justify-center">
          <Link
            to="/"
            className="inline-flex w-fit items-center gap-3 rounded-full border border-[#8f355d]/10 bg-white px-4 py-3 shadow-[0_14px_36px_rgba(143,53,93,0.08)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_18px_42px_rgba(143,53,93,0.14)]"
          >
            <picture>
              <source srcSet={logoSvgSrc} type="image/svg+xml" />
              <img
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3">
            <span className="inline-block w-fit rounded-full border border-[#8f355d]/10 bg-white px-4 py-2 text-[11px] uppercase tracking-[0.3em] text-[#9b5a79]">
              {categoryLabel}
            </span>
          ...
          <div className="mt-8 rounded-[1.7rem] border border-[#8f355d]/10 bg-white px-5 py-5 shadow-[0_12px_34px_rgba(143,53,93,0.06)]">
          ...
          <div className="mt-10 rounded-[1.9rem] border border-[#8f355d]/10 bg-white px-6 py-6 shadow-[0_12px_34px_rgba(143,53,93,0.06)]">
            <p className="text-[11px] uppercase tracking-[0.28em] text-[#a55b7d]">
              Porque escolher este artigo
            </p>

            <h2 className="mt-3 font-serif text-2xl font-semibold leading-tight text-[#6f2947]">
